...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "The Search-to-Call Foundation combines them because they work together, but the exact work depends on your current online presence and where the biggest gaps are.",
  },
  {
    id: "faq-2",
    question: "Do you build a new website or improve my existing one?",
    answer:
      "The offer is built around a custom, mobile-first website. We'll first look at your current presence and determine what makes the most sense for the project.",
  },
  {
    id: "faq-3",
    question: "Does this include ongoing SEO?",
    answer:
      "No. The Search-to-Call Foundation includes the technical SEO foundation needed for launch, but ongoing SEO is not included.",
  },
  {
    id: "faq-4",
    question: "How long does the project take?",
    answer:
      "Typically 3–5 weeks from deposit, completed intake, required content, and timely approvals.",
  },
  {
    id: "faq-5",
    question: "Do you guarantee rankings or leads?",
    answer:
      "No. No legitimate provider can guarantee rankings, traffic, calls, leads, jobs, or revenue. The goal is to build a stronger foundation and make the customer journey easier.",
  },
];
