...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "It's the process of improving the foundational information and structure of your Google Business Profile so customers can more easily understand your business and find the information they need.",
  },
  {
    id: "faq-2",
    question: "Can you optimise my existing Google Business Profile?",
    answer:
      "Yes. The Search-to-Call Foundation includes reviewing your existing profile and completing the foundational optimisation work within the project scope.",
  },
  {
    id: "faq-3",
    question: "Do I need to give you access to my Google Business Profile?",
    answer:
      "Yes. GBP access is required for the project. We'll confirm access during the intake process.",
  },
  {
    id: "faq-4",
    question: "Will this guarantee higher Google Maps rankings?",
    answer:
      "No. Google rankings depend on many factors outside our control. We don't guarantee rankings, traffic, calls, leads, jobs, or revenue.",
  },
  {
    id: "faq-5",
    question: "Do you manage Google reviews?",
    answer:
      "Review management is not included in the current offer. We can integrate existing reviews and proof into your website as part of the foundation.",
  },
];

const EASE = [0.16, 1, 0.3, 1] as const;

export function GBPFAQSection() {
